...
export default function Keyboard({
  ...
  return (
    <div className="flex flex-col gap-[3px] sm:gap-1 w-full max-w-[420px] sm:max-w-[500px]" role="group" aria-label="Keyboard">
            ...
            return (
              <button
                ...
                className={`h-[46px] sm:h-14 rounded-[4px] flex items-center justify-center border transition-colors duration-200 text-[13px] sm:text-base font-semibold select-none ${
                  isSpecial ? "px-1.5 sm:px-2 min-w-[46px] sm:min-w-[65px]" : "flex-1 min-w-0"

    ...
    <div className="flex items-center justify-center min-h-screen bg-white dark:bg-zinc-900 p-4">
      <div className="w-full max-w-sm">
        ...
        <p className="text-center text-zinc-500 dark:text-zinc-400 mb-8">
          to save your stats and appear on the leaderboard
        </p>

        <div className="space-y-3">
          <button
            onClick={() => signIn("google", { callbackUrl: "/" })}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-zinc-300 dark:border-zinc-700 rounded-xl hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors font-medium text-black dark:text-white"
          >
